...
train_loader = DataLoader(TensorDataset(x0_, x0_), batch_size=100, shuffle=True)
...
modelmse_tst = mean_squared_error(x0_.view(x0_.size(0), -1).numpy(), x0_pred.reshape(x0_pred.shape[0], -1))
print('Test set mse:', round(modelmse_tst, 8))
